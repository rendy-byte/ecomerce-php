						...
						<div class="accordion" id="accordion2">
							<div class="accordion-group">
								<div class="accordion-heading">
									<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">Masukkan ID Membership Anda.!</a>
								</div>
							...
							<form class="form-horizontal" method="get" action="membership.php"> 
                            	<fieldset>
									...
									<div class="control-group">
                                        <label class="control-label"><strong>Cari ID</strong></label>
                                        <div class="controls">
                                            <input type="text" required placeholder="Masukkan ID Member" name="cari" class="input-xlarge">
                                        </div>
                                    </div>
