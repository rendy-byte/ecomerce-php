...
<html lang="en">
    ...
    <body>		
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/clients/sport.jpg" alt="New products" >
				<h4><span>Sport Station SOLO SQUARE</span></h4>
			</section>
					...
					<div class="span12">								
						<ul class="thumbnails listing-products">
							<?php
								...
								$page_query = mysql_query("SELECT COUNT(*) FROM barang  where kategori='SPORT STATION'");
								$pages = ceil(mysql_result($page_query, 0) / $per_page);

								$page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
								$start = ($page - 1) * $per_page;
										
								$query = mysql_query("SELECT * FROM barang where kategori='SPORT STATION' LIMIT $start, $per_page");
