                    ...
                    <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Tambah Slide</div>
                            </div>
                            
                            <div class="block-content collapse in">
                                <div class="span12">
                                	 <form class="form-horizontal" name="input_barang" enctype="multipart/form-data" method="post" action="insert-slide.php"> 
                                      <fieldset>
