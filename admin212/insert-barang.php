...
if (!empty($_FILES["gbarang"]["tmp_name"]))
{
    ...
    {           
        ...
        if (move_uploaded_file($_FILES['gbarang']['tmp_name'], $gambar)) 
		{
            ...
            $sql = "INSERT INTO barang (id_brg, nama_brg, harga_brg, desc_brg, jml_brg, kategori,wa, gambar_brg) values ('$kdBrg', '$namaBarang', '$hrgBarang' , '$descBarang', '$jmlBrg', '$kategoriBrg', '$watoko','$gambar')";
