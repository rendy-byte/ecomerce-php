                    ...
                    <div class="row-fluid section">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                	 <form class="form-horizontal" name="input_tenant" method="post" action="insert-tenant.php"> 
                                      <fieldset>
                                      <div class="control-group">
                                          <label class="control-label" for="focusedInput">Id Tenant</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="id" type="text" placeholder="Tidak perlu di isi" value="<?php $a="RUKO"; $b=rand(1000,10000); $c=$a.$b; echo $c; ?>" autofocus="on" readonly="readonly" />
                                          </div>
                                        </div>
                                      <div class="control-group">
                                          <label class="control-label" for="focusedInput">Nama Tenant</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="tenant" type="text" placeholder="input nama tenant" onkeyup="this.value = this.value.toUpperCase()">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Nomer Kavling</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="kavling" type="text" placeholder="input no kavling" onkeyup="this.value = this.value.toUpperCase()">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="select01">Lantai </label>
                                          <div class="controls">
                                            <select id="select01" class="chzn-select" name="lantai">
                                              <option>GFC</option>
                                              <option>GF</option>
                                              <option>FF</option>
                                              <option>SF</option>
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="penanggungjawab" type="text" placeholder="input penanggung jawab" onkeyup="this.value = this.value.toUpperCase()">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">WhatShapp Tenant</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="wa" type="text" placeholder="input berbentuk angka" onkeypress="return event.charCode >= 48 && event.charCode <=57">
                                          </div>
                                        </div>
