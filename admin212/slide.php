                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Daftar Slide</div>
                            </div>
                            <div class="block-content collapse in">
                            	 <table class="table table-striped">
                                        ...
                                        <tbody>
											...
											$page_query = mysql_query("SELECT COUNT(*) FROM slider");
											$pages = ceil(mysql_result($page_query, 0) / $per_page);
 
											$page = (isset($_GET['page'])) ? (int)$_GET['page'] : 1;
											$start = ($page - 1) * $per_page;
											
											$query = mysql_query("SELECT * FROM slider LIMIT $start, $per_page");
										 
											while ($data = mysql_fetch_array($query)) {
											?>
												<tr>
													<td><?php echo $data['id']; ?></td>
													<td><?php echo '<img src="'.$data['gambar'].'" width = "200" height = "200" />'; ?></td>   												
                                                    <td><a href="edit-slide.php?id=<?php echo $data['id']; ?>" class="btn">
                                                    <i class="icon-edit"></i> Edit</a> | <a href="delete-slide.php?id=<?php echo $data['id']; ?>" class="btn" onclick="return confirm('Anda Yakin ?')")><i class="icon-trash"></i>Hapus</a></td>
												</tr>
											<?php	
											}
											?>
                            ...
                            <div class="navbar navbar-inner block-header">
                            	 <a href="tambah-slide.php" class="btn"><i class="icon-plus"></i> Tambah</a>
                            </div>
                        </div>
                        <!-- /block -->
                    </div>
