                ...
                <div class="span9" id="content">
                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                                        ...
                                        <tbody>
											...
											?>
												<tr>
                                                    ...
                                                    <td><?php echo '<img src="'.$data['gambar_brg'].'" alt="'.$data['nama_brg'].'" title="'.$data['nama_brg'].'" width = "100" height = "100" />'; ?></td>   												
                                                    <td><a href="edit-barang.php?id=<?php echo $data['id_brg']; ?>" class="btn">
                                                    <i class="icon-edit"></i> Edit</a> | <a href="delete-barang.php?id=<?php echo $data['id_brg']; ?>" class="btn" onclick="return confirm('Anda Yakin ?')")><i class="icon-trash"></i>Hapus</a></td>
												</tr>
											<?php	
											}
											?>
                            ...
                            <div class="navbar navbar-inner block-header">
                            	 <a href="tambah-barang.php" class="btn"><i class="icon-plus"></i> Tambah</a>
                            </div>
                        </div>
                        <!-- /block -->
                    </div>
