                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a tabindex="-1" href="user.php">Edit Tenant</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <div class="row-fluid section">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit Tenant</div>
                            </div>
                            <?php
							$id = $_GET['id'];
							$query = mysql_query("select * from tbtenant where id='$id'") or die(mysql_error());
							$data = mysql_fetch_array($query);
							?>
                            <div class="block-content collapse in">
                                <div class="span12">
                                	 <form class="form-horizontal" name="edit_user" method="post" action="update-tenant.php">
                                     <input type="hidden" name="id" value="<?php echo $id; ?>" /> 
                                      <fieldset>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Nama Tenant</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="namatenant" type="text" value="<?php echo $data['tenant']; ?>" disabled >
                                          </div>
                                        </div>
                                    
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">WhatShapp</label>
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="wa" type="text" value="<?php echo $data['wa']; ?>" >
                                          </div>
                                        </div>
