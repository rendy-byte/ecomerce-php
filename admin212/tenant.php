                ...
                <div class="span9" id="content">
                	<?php
						if (!empty($_GET['message']) && $_GET['message'] == 'success') {
							...
							echo '<h4>Success Menambah Tenant</h4>';
							echo '</div>';
						}
						else if (!empty($_GET['message']) && $_GET['message'] == 'update') {
							echo '<div class="alert alert-success">' ;
							echo '<button type="button" class="close" data-dismiss="alert">&times;</button>'; 
							echo '<h4>Success Update Tenant</h4>';
							echo '</div>';
						}
						else if (!empty($_GET['message']) && $_GET['message'] == 'delete') {
							echo '<div class="alert alert-success">' ;
							echo '<button type="button" class="close" data-dismiss="alert">&times;</button>'; 
							echo '<h4>Success Delete Tenant</h4>';
							echo '</div>';
						}
					...
					<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Daftar Tenant Shop </div>
                            </div>
                            <div class="block-content collapse in">
                            	 <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <?php
											$query = mysql_query("select * from tbtenant");
											...
											?>
												<tr>
													...
													<td><?php echo $data['kavling']; ?></td>
													<td><?php echo $data['lantai']; ?></td>
                                                    <td><?php echo $data['wa']; ?></td>
													<td><a href="edit-tenant.php?id=<?php echo $data['id']; ?>" class="btn"><i class="icon-edit"></i> Edit</a> | <a href="delete-tenant.php?id=<?php echo $data['id']; ?>" class="btn"><i class="icon-trash"></i>Hapus</a></td>
												</tr>
											<?php
												$no++;
											}
                            ...
                            <div class="navbar navbar-inner block-header">
                            	 <a href="tambah-tenant.php" class="btn"><i class="icon-plus"></i> Tambah</a>
                            </div>
                        </div>
                        <!-- /block -->
                    </div>
