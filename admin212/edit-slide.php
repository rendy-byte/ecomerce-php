                ...
                <div class="span9" id="content">
                    ...
                    <div class="row-fluid section">
                        ...
                        <div class="block">
                            ...
                            <?php
							$id = $_GET['id'];
							$query = mysql_query("SELECT * FROM slider WHERE id='$id'") or die(mysql_error());
                                ...
                                <div class="span12">
                                     ...
                                     <fieldset>
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="kdbarang" type="text" value="<?php echo $data['id']; ?>">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="fileInput">Gambar </label>
                                          <div class="controls">
                                            <?php echo '<img src="'.$data['gambar'].'">'; ?>
