                                ...
                                <div class="span12">
                                	 <form class="form-horizontal" name="input_user" method="post" action="insert-user.php"> 
                                      ...
                                      <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input class="input-xlarge focused" name="firstname" type="text" placeholder="firstname">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                        ...
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Hak Ases</label>
                                          <div class="controls">
                                            <select class="input-xlarge focused" name="hakases" type="text" required="required">
