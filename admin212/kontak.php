...
<html>
<head>
        <title>Manage Halaman Kontak</title>
        <!-- Bootstrap -->
		                    ...
		                    <div class="row-fluid">
		                        ...
		                        <div class="block">
		                            <div class="navbar navbar-inner block-header">
		                                <div class="muted pull-left">Manage Halaman Kontak</div>
		                            </div>
                                    <h2 align="center">Atur Halaman Kontak</h2>
		                            <div class="block-content collapse in">
		                               	<form action="simpan-kontak.php" method="post">
                                        <?php
											$query = mysql_query("SELECT * FROM pagekontak") or die(mysql_error());
